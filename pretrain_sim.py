...
if __name__ == '__main__':
    ...
    pretrain_val_dataset = PretrainDataset(partition = 9, transforms=val_transform, split_file='pretrain_val.txt')
    ...
    for epoch in range(args['num_epoch']):
        pretrain_dataset = PretrainDataset(partition = epoch%9, transforms=train_transform, split_file='pretrain.txt')
        train_loss, model = train_epoch(model, epoch, criterion, optimizer, pretrain_dataset, args, log)
        scheduler.step()
        val_loss, val_acc = val_epoch(model, epoch, criterion, pretrain_val_dataset, args)
